...
const nbOfCards = 18; // Has to be a multiple of 2
...
function initSetup() {
  for (let i = 1; i < nbOfCards + 2; i = i + 2) {
  ...
  for (let i = 0; i < nbOfCards; i++) {
    ...
    do {
      var pickedCard = pickCard(getRandomInt(nbOfCards / 2));
    } while (pickedCard == -1);
...
function updateScore() {
  score++;
  scoreContainer.textContent = "Score : " + score + "/" + nbOfCards / 2;
}
